({
            ...
            $(document).ready(function(){
                ...
                $.each(eventsArray, function(index, value){
                    ...
                    if (bgColor != undefined ) {
                         newEvent.backgroundColor = bgColor;
                    }
                    if (borderColor != undefined ) {
                        newEvent.borderColor = borderColor;
                    }
                ...
                $('#calendar').fullCalendar({
                    ...
                    drop: function(event, delta, revertFunc) {
                        ...
                        console.log(component.get("v.showSpinner"));
                            console.log('Subject',component.get("v.draggedEventAccountName"));
                            var newEvent = {
                                OwnerId: component.get("v.selectedUser"),
                                leadId: component.get("v.draggedEventId"),
    ...
    saveEvent : function(component, newEvent, callback) {
        ...
        console.log(component.get("c.saveNewEvent"));
        action.setParams({ 
            "ownerId": newEvent.OwnerId,
            "subject": newEvent.Subject,
            "startDateTime": newEvent.StartDateTime,
    ...
    rerenderCalendar : function(component) {
      ...
      //  console.log('event handler in child');
       // cmpEvent.setParams({
